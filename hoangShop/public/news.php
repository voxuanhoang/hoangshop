    ...
    <div class="container-tintuc">
      ...
      <?php 
         while($result = $show_tintuc->fetch_assoc()){
          ?>
        <a href="chitiet/chitietnews.php?news_idd=<?php echo $result['news_idd'] ?>" class="container-tintuc-main">
            <img src="../admin/uploadsnews/<?php echo $result['news_img'] ?>"><br>
            <p style="font-weight: bold;"><?php echo $result['title_news'] ?></p>
            <p><?php echo $result['tomtat_noidung'] ?> [...]</p>
        </a>
        <?php     
                         }
                    ?>
      ...
      <section class="container-tintuc-right">
         ...
         while($result = $show_tintuc2->fetch_assoc()){
          ?>
          <a href="chitiet/chitietnews.php?news_idd=<?php echo $result['news_idd'] ?>" class="container-tintuc-right-bottom">
